...
namespace Services.SceneManagement
{
    ...
    {
        [AutoService]
        protected IClassEventSystem eventSystem;
        ...
        {
            eventSystem.Fire(this,OnBeforeSceneLoadArgs.Create(index));
        }

        private void AfterLoadScene(int index)
        {
            eventSystem.Fire(this,OnAfterSceneLoadArgs.Create(index));
        }
    }
}