...
namespace Framework.Editor
{
    ...
    public class ProcedureManagerInspector : FrameworkInspector
    {
            ...
            EditorGUI.BeginDisabledGroup(EditorApplication.isPlayingOrWillChangePlaymode);
            {
                ...
                if (m_ProcedureTypeNames.Length > 0)
                {
                    EditorGUILayout.BeginVertical("box");
                    {
                        ...
                        {
                            if(procedureTypeName == typeof(ProcedureBase).ToString())continue;
        ...
        {
            m_ProcedureTypeNames = TypeUtils.GetRuntimeTypeNames(typeof(ProcedureBase));
