...
namespace MirMirrorEditor
{
    ...
    public class MMDialogue_Gragh : ScriptableObject
    {
        ...
        public List<DialoguePartGraghData> m_DialoguePartGraghDatas;
        
    }
    [System.Serializable]
    public class DialoguePartGraghData
    {
        [SerializeField]
        ...
        public DialoguePartGraghData()
        {
            m_GraghDialogueNodes = new List<GraghDialogueNode>();
            m_GraghChoiceNodes = new List<GraghChoiceNode>();
            m_GraghEventNodes = new List<GraghEventNode>();
            m_Points = new List<ConnectionPoint>();
