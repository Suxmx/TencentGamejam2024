    ...
    public class ConnectionPoint
    {
        ...
        public MyGraghNode Owner
        {
            get
            {
                ...
                {
                    case NODETYPE.START:
                        return m_Editor.CurMMDialogue_Gragh.m_DialoguePartGraghDatas[m_Editor.m_CurtPartID].m_GraghStartNode;

                    case NODETYPE.DIALOGUE:
                        return m_Editor.CurMMDialogue_Gragh.m_DialoguePartGraghDatas[m_Editor.m_CurtPartID].GetGraghDialogueNode(m_Owner.ID);
                    case NODETYPE.CHOICE:
                        return m_Editor.CurMMDialogue_Gragh.m_DialoguePartGraghDatas[m_Editor.m_CurtPartID].GetGraghChoiceNode(m_Owner.ID);
                    case NODETYPE.EVENT:
                        return m_Editor.CurMMDialogue_Gragh.m_DialoguePartGraghDatas[m_Editor.m_CurtPartID].GetGraghEventNode(m_Owner.ID);
        ...
        {
            m_Editor = _Editor;
            m_PointID = m_Editor.CurMMDialogue_Gragh.m_DialoguePartGraghDatas[m_Editor.m_CurtPartID].GetPointUniqueID();
            ...
            m_Editor.CurMMDialogue_Gragh.m_DialoguePartGraghDatas[m_Editor.m_CurtPartID].m_Points.Add(this);
