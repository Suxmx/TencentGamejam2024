...
namespace MirMirrorEditor
{
    ...
    public class GraghDialogueNode : MyGraghNode
    {
        ...
        public GraghDialogueNode(Vector2 startPos, Vector2 size, NodeID_Type _NodeID_Type, MM_DialogueNodeEditor _Editor) : base(startPos, size, _NodeID_Type,_Editor)
        {
            ...
            m_Editor.CurMMDialogue_Gragh.m_DialoguePartGraghDatas[m_Editor.m_CurtPartID].m_GraghDialogueNodes.Add(this);
            m_Editor.CurMMDialogue_Gragh.m_MMDialogue_Data.m_DialoguePartDatas[m_Editor.m_CurtPartID].m_DataDialogueNodes.Add(new DataDialogueNode(this.m_NodeID_Type.ID));
