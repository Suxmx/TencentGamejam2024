...
namespace MirMirrorEditor
{
    ...
    public class GraghEventNode : MyGraghNode
    {
        ...
        public GraghEventNode(Vector2 startPos, Vector2 size, NodeID_Type _NodeID_Type, MM_DialogueNodeEditor _Editor) : base(startPos, size, _NodeID_Type,_Editor)
        {
            ...
            m_Editor.CurMMDialogue_Gragh.m_DialoguePartGraghDatas[m_Editor.m_CurtPartID].m_GraghEventNodes.Add(this);
            m_Editor.CurMMDialogue_Gragh.m_MMDialogue_Data.m_DialoguePartDatas[m_Editor.m_CurtPartID].m_DataEventNodes.Add(new DataEventNode(this.DataNode.ID));
